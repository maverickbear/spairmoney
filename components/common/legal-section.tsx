...
const CONTENT_CLASS =
  "px-6 py-4 sm:px-6 sm:py-5 space-y-4 text-sm text-muted-foreground [&_ul]:list-disc [&_ul]:list-inside [&_ul]:space-y-2 [&_ul]:ml-4 [&_ul_ul]:ml-6 [&_ul_ul]:mt-2 [&_li]:leading-relaxed [&_h3]:font-semibold [&_h3]:mb-2 [&_h3]:text-foreground [&_a]:text-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:--sentiment-positive [&_div]:space-y-4";
