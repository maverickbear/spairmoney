 ...
 * All plan changes and cancellations must be done through Stripe Customer Portal.
...
export async function POST(request: NextRequest) {
  try {
    ...
    // CRITICAL: All plan changes and cancellations must be done through Stripe Customer Portal
    ...
    return NextResponse.json({
      ...
      message: "Redirecting to Stripe Customer Portal to manage your subscription. All plan changes and cancellations must be made through Stripe.",
    });
  } catch (error) {
