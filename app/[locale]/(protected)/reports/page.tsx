...
export async function generateMetadata() {
  ...
  return {
    title: `${t("pages.reports")} - ${t("titleSuffix")}`,
...
export default async function ReportsPage({ searchParams }: ReportsProps) {
  ...
  return (
    <div>
      <PageHeader title={t("items.reports")} />
      ...
      <SimpleTabs defaultValue="overview" className="w-full">
        ...
        <FixedTabsWrapper>
          <SimpleTabsList className="flex-wrap">
            <SimpleTabsTrigger value="overview">{tReports("overview")}</SimpleTabsTrigger>
            <SimpleTabsTrigger value="net-worth">{tReports("netWorth")}</SimpleTabsTrigger>
            <SimpleTabsTrigger value="income-expenses">{tReports("incomeExpenses")}</SimpleTabsTrigger>
            <SimpleTabsTrigger value="debts">{tReports("debts")}</SimpleTabsTrigger>
            <SimpleTabsTrigger value="goals">{tReports("goals")}</SimpleTabsTrigger>
            <SimpleTabsTrigger value="accounts">{tReports("accounts")}</SimpleTabsTrigger>
            <SimpleTabsTrigger value="insights">{tReports("insights")}</SimpleTabsTrigger>
          </SimpleTabsList>
        </FixedTabsWrapper>
