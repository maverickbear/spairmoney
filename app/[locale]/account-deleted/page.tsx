...
export default function AccountDeletedPage() {
  ...
  const t = useTranslations("accountStatus.deleted");
      ...
      <div className="flex-1 flex items-center justify-center p-4 pt-24 md:pt-28">
        <div className="max-w-md w-full space-y-8 text-center">
          ...
          <Card className="border-destructive/50">
            <CardHeader>
              <CardTitle className="text-destructive">{t("deletionComplete")}</CardTitle>
              <CardDescription>{t("deletionCompleteDescription")}</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="rounded-lg border border-destructive/50 bg-destructive/10 p-4">
                <p className="text-sm text-destructive">{t("permanentMessage")}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t("whatWasDeleted")}</CardTitle>
            </CardHeader>
