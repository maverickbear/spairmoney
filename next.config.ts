        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://spair.co https://app.spair.co wss://app.spair.co https://api.stripe.com https://js.stripe.com https://vercel.live https://www.googletagmanager.com https://*.google-analytics.com https://va.vercel-scripts.com https://challenges.cloudflare.com https://*.api.sanity.io wss://*.api.sanity.io https://sanity-cdn.com https://*.sanity-cdn.com https://registry.npmjs.org", // Sanity Studio: api.sanity.io, sanity-cdn.com (modules); registry.npmjs.org for package version check
