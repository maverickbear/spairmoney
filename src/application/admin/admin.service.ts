...
export class AdminService {
  ...
  async getDashboardData(): Promise<{
    ...
    const { totalUsers, subscriptions, plans } = await this.repository.getDashboardData();
    ...
    const usersWithoutSubscription = totalUsers - usersWithSubscription.size;
